...
public class FavouriteListAdapter extends RecyclerView.Adapter<FavouriteListAdapter.FavoriteHolder> {
    ...
    public FavouriteListAdapter(ArrayList<MyQuestion> questions, String user, Context context) {
        this.user = user;
    ...
    public void addQuestion(ArrayList<MyQuestion> questions) {
        ...
        Log.d("questions size", String.valueOf(questions.size()));
    ...
    public FavoriteHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        FavouriteListAdapter.FavoriteHolder favoriteHolder = new FavouriteListAdapter.FavoriteHolder(view);
